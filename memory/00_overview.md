...
| 2 | **Pretraining** | [`base_train.py`](../scripts/base_train.py) | [`gpt.py`](../nanochat/gpt.py), [`optim.py`](../nanochat/optim.py), [`dataloader.py`](../nanochat/dataloader.py) | config & scaling laws, init, transformer, attention, next-token loss, LR schedule, DDP | [08](08_model_config_and_scaling.md), [09](09_weight_initialization.md), [10](10_embedding_stage.md) … |
